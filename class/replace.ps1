...
<div id="ubgHeader" class="app-header desktop-nav-layout">
    <div class="header-left"><!--$--><button aria-label="Open/Close sidebar" class="sidebar-toggle-btn"> </button><a
        href="/">
        <div class="site-logo">
          <div class="logo-icon"><img src="/favicon.png" alt="Pac Man Unblocked" class="logo-image"
              style="width: 40px; height: 40px; margin-right: 10px;"><strong
              style="color: rgb(255, 255, 255); font-size: 24px;font-family:'Franklin Gothic Medium', 'Arial Narrow', Arial, sans-serif">Pac Man</strong></div>
        </div>
      </a><!--/$--></div>
  ...
  <div id="skrHeader" class="Header_mobile-43dhd mobile-nav-layout">
    <div class="Header_left-43dhd"><!--$--><a href="/">
        <div class="logo-43dhd">
          <div class="logo_icon-48dhd"><img src="/favicon.png" alt="Pac Man" class="logo_image-48dhd">
          </div>
        </div>
      </a><!--/$--></div>
    <div class="header-right">
